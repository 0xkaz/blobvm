...
if ! [[ "$0" =~ scripts/run-without-anr.sh ]]; then
...
# ./cmd/blobvm
go build \
-o $AVALANCHEGO_PLUGIN_DIR/kM6h4LYe3AcEU1MB2UNg6ubzAiDAALZzpVrbX8zn3hXF6Avd8 \
./cmd/blobvm
